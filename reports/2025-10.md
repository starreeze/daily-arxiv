...
*Date Range: [2025-10-28, 2025-10-29)*
...
MLLMs struggle with visual planning and imagination despite strong visual understanding; humans use sketching for visual thinking.

**Method:**

Introduces Latent Sketchpad, integrating autoregressive visual latent generation and a sketch decoder into MLLMs for multimodal reasoning.
...
**Link:** https://arxiv.org/pdf/2510.24342

**Motivation:**

Lack of a unified framework to compare how diverse AI models organize information relative to the human brain across modalities and tasks.

**Method:**

Proposes Brain-like Space, mapping AI models’ attention topology onto human brain networks to quantify and compare intrinsic brain-likeness.
...
**Link:** https://arxiv.org/pdf/2510.24331

**Motivation:**

Multimodal in-context learning in VLMs is underexplored, with unclear understanding of how visual and textual cues are integrated during ICL.

**Method:**

Systematically evaluates ICL in VLMs via benchmarks and attention analysis, revealing limited visual reliance and trade-offs in training strategies.
...
**Link:** https://arxiv.org/pdf/2510.24214

**Motivation:**

Existing visual token pruning in MLLMs focuses only on saliency, often sacrificing semantic completeness due to poor coverage.

**Method:**

Proposes SCOPE, a pruning method that jointly optimizes saliency and coverage using token-coverage gain integrated with attention scores.
...
**Link:** https://arxiv.org/pdf/2510.24161

**Motivation:**

Current MLLMs and embodied models fail to generalize across digital-physical spaces, tasks, and robot embodiments seamlessly.

**Method:**

Introduces BLM₁, a spatial foundation model trained in two stages to embed embodied knowledge and enable cross-space, cross-task, cross-embodiment control.
...
*Date Range: [2025-10-29, 2025-10-30)*
...
**Link:** https://arxiv.org/pdf/2510.25760

**Motivation:**

Lack of systematic reviews and public benchmarks for multimodal spatial reasoning with large models.

**Method:**

Surveys recent progress in multimodal large language models, categorizes spatial reasoning tasks, and introduces open benchmarks covering 2D/3D, embodied AI, and emerging modalities.
...
**Link:** https://arxiv.org/pdf/2510.25332

**Motivation:**

Existing VideoQA datasets ignore temporal answer evolution and lack explicit reasoning annotations for streaming videos.

**Method:**

Proposes StreamingCoT dataset with per-second dense descriptions, temporally-dependent segments, and human-verified multimodal chain-of-thought reasoning paths derived via LLMs.
...
**Link:** https://arxiv.org/pdf/2510.25179

**Motivation:**

Static safety layers for vision-language models offer limited context awareness and interpretability against jailbreak attacks.

**Method:**

Introduces Agentic Moderation: a multi-agent framework with Shield, Responder, Evaluator, and Reflector for dynamic, interpretable, and cooperative safety alignment.
...
*Date Range: [2025-10-30, 2025-10-31)*

### SteerVLM: Robust Model Control through Lightweight Activation Steering for Vision Language Models

**Authors:** Anushka Sivakumar, Andrew Zhang, Zaber Hakim, Chris Thomas

**Link:** https://arxiv.org/pdf/2510.26769

**Motivation:**

Addresses the need for fine-grained, lightweight control over Vision-Language Model outputs without weight modification.

**Method:**

Introduces a tiny steering module that modulates activations between language and vision modalities using paired prompt embeddings.
...
**Link:** https://arxiv.org/pdf/2510.26721

**Motivation:**

Investigates the root cause of text bias in Multimodal LLMs, challenging assumptions about external data factors.

**Method:**

Analyzes attention key-space distributions to show visual keys are out-of-distribution relative to textual keys, causing underutilization.
...
Aims to build a native multimodal world model capable of unified vision-language prediction and generation.

**Method:**

Pre-trains Emu3.5 on interleaved video-text data with next-token prediction and uses Discrete Diffusion Adaptation for fast inference.
...
**Link:** https://arxiv.org/pdf/2510.26466

**Motivation:**

Tackles object-context shortcut reliance in zero-shot VLM recognition under distribution shifts.

**Method:**

Applies representation-level counterfactual calibration by recombining object features with alternative contexts to isolate causal effects.
...
**Link:** https://arxiv.org/pdf/2510.26241

**Motivation:**

Exposes poor temporal reasoning in VLMs by evaluating their ability to discern the arrow of time in videos.

**Method:**

Introduces a psychophysics-grounded benchmark (AoT-PsyPhyBENCH) comparing VLM performance to human baselines on time-direction tasks.
